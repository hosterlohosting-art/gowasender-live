...
class SubscriptionController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.subscription.payment', compact('plan', 'gateways', 'tax', 'total', 'invoice_data', 'primary_data'));
    }
    ...
    public function success()
    {
        ...
        $redirectUrl = auth()->user()->will_expire == null ? '/user/cloudapi/create' : '/user/dashboard';

        auth()->user()->will_expire == null ? Session::put('new-user', __('Lets create a whatsapp cloudapi')) : null;
