   ...
   // $template->uuid = $uuid;
    ...
    public function store(Request $request,$type)
    {
        ...
        elseif ($type == 'meta-template') 
        {
            ...
            $templateStatus = $whatsapp_app_cloud_api->createTemplate($templateRawData, $header, $body, $footer, $buttons,$accountId, $accessToken);
        ...
        if ($type == 'meta-template' && $templateStatus == 200){
            return response()->json([
    ...
    public function update(Request $request,$id)
    {
        ...
        if ($type == 'text-with-template'){
            $template=$this->saveCloudTemplate($request->all(),$type,Auth::id(),$templateStatus,$id);
        }else{
