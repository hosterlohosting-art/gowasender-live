            ...
            try {
                ...
                elseif($type == 'text-with-media'){
                    ...
                    if (isset($data['image']) && !empty($data['image']['url'])) {
                        ...
                        $resonse=$whatsapp_app_cloud_api->sendImage($contact->phone, $link_id);
                    ...
                    elseif (isset($data['document']) && !empty($data['document']['url'])) {
                        ...
                        $resonse =$whatsapp_app_cloud_api->sendDocument($contact->phone, $link_id, $document_name);
                        $this->saveMessageToUserChat($userChat,$template->title,$type, $contact->phone, $cloudapi_id);
                    }
                    ...
                    $resonse=$whatsapp_app_cloud_api->sendLocation($contact->phone, $longitude, $latitude, '', $template->title);
                    $this->saveMessageToUserChat($userChat,$template->title,$type, $contact->phone, $cloudapi_id);
