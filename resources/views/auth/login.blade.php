                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn my-4 shadow-lg"
                                        style="background-color: #00a884; color: #fff; border: none; width: 100%; border-radius: 2rem; font-weight: 600;">{{ __('Sign in') }}</button>
                                    ...
                                    <a href="{{ route('auth.google') }}" class="btn btn-neutral btn-icon my-3 shadow-none"
                                        ...
                                        <span
                                            class="btn-inner--text font-weight-bold ml-2">{{ __('Sign in with Google') }}</span>
                                    </a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-6">
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    style="color: #8696a0;"><small>{{ __('Forgot password?') }}</small></a>
                            @endif
                        </div>
                        <div class="col-6 text-right">
                            <a href="{{ url('/pricing') }}"
                                style="color: #00a884;"><small>{{ __('Create new account') }}</small></a>
                        </div>
                    </div>
