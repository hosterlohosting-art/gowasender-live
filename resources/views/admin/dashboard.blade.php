...
@section('content')
	<div class="row">
		<div class="col-xl-3 col-md-6">
			<div class="card card-stats premium-card">
				<!-- Card body -->
				<div class="card-body">
					<div class="row">
						<div class="col">
							<h5 class="card-title text-uppercase text-muted mb-0">{{ __('Total Orders') }}</h5>
							<span class="h2 font-weight-bold mb-0 text-dark" id="total-orders"><img
				...
				<div class="card-body">
					<div class="row">
						<div class="col">
							...
							<span class="h2 font-weight-bold mb-0 mt-1 text-dark" id="pending-orders"><img
									src="{{ asset('uploads/loader.gif') }}"></span>
						</div>
						<div class="col-auto">
							<div class="icon icon-shape bg-gradient-primary text-white rounded-circle shadow">
				...
				<div class="card-body">
					<div class="row">
						<div class="col">
							...
							<span class="h2 font-weight-bold mb-0 text-dark" id="open-support"><img
									src="{{ asset('uploads/loader.gif') }}"></span>
						</div>
						<div class="col-auto">
							<div class="icon icon-shape bg-gradient-primary text-white rounded-circle shadow">
				...
				<div class="card-body">
					<div class="row">
						<div class="col">
							...
							<span class="h2 font-weight-bold mb-0 text-dark" id="active-customers"><img
									src="{{ asset('uploads/loader.gif') }}"></span>
						</div>
						<div class="col-auto">
							<div class="icon icon-shape bg-gradient-primary text-white rounded-circle shadow">
		...
		<div class="col-sm-9">
			<div class="card premium-card">
				<div class="card-header">
					<h4><i class="fi fi-rs-shopping-cart text-primary"></i> <span
							class="ml-2">{{ __('Overview Of Sales Value') }}</span></h4>
					<div class="card-header-action dropdown">
						<a href="#" data-toggle="dropdown"
							class="btn btn-neutral btn-sm dropdown-toggle overview-target">{{ __('Monthly') }}</a>
						<ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
							<li><a href="#" class="dropdown-item overview-list" data-type="Weekly">{{ __('This Week') }}</a>
							</li>
							<li><a href="#" class="dropdown-item overview-list"
									data-type="Monthly">{{ __('This Month') }}</a></li>
					...
					<ul class="list-group list-group-flush list my--3">
							...
							<div class="row align-items-center">
								<div class="col ml--2">
									<h4 class="mb-0 text-muted">
										<i class="fi fi-rs-devices text-primary"></i> {{ __('Active CloudApis') }}
									</h4>
						...
						<li class="list-group-item px-0 ml-2">
							<div class="row align-items-center">
								<div class="col ml--2">
									<h4 class="mb-0 text-muted">
										<i class="fi  fi-rs-trash text-primary"></i> {{ __('Junk CloudApis') }}
									</h4>
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="card premium-card">
				<div class="card-header">
					<h4><i class="fi  fi-rs-shopping-bag text-primary"></i> <span
							class="ml-1">{{ __('Recent Orders') }}</span></h4>
				</div>
				<div class="card-body">
		...
		<div class="col-sm-8">
			<div class="card premium-card">
				<div class="card-header bg-transparent">
					<div class="row align-items-center">
						<div class="col">
							<h2 class="h3 mb-0"><i class="fi-rs-hand-holding-box text-primary"></i> <span
									class="ml-2">{{ __('Popular Plan') }}</span></h2>
						</div>
					</div>
				</div>
