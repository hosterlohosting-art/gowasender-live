...
@section('head')
    @include('layouts.main.headersection', ['title' => __('Contacts')])
@endsection
@section('content')
                ...
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Schedule Contacts') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card">
                            ...
                            <tbody class="list">
                                @foreach($contacts ?? [] as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-dark" href="{{ route('admin.customer.show', $contact->user_id) }}">
                                                {{ Str::limit($contact->user->name ?? '', 15) }}
                                            </a>
                                        </td>
                                        <td>
                                            {{ $contact->phone }}
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item delete-confirm" href="#"
                                                        data-action="{{ route('admin.contacts.destroy', $contact->id) }}">{{ __('Remove') }}</a>
                ...
                <div class="card-footer py-4">
                    {{ $contacts->appends($request->all())->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
