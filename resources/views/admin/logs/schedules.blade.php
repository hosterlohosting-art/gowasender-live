                ...
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Total Schedules') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Upcoming Schedules') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Executed Schedules') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="" class="card-header-form">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="type">
                                ...
                                <option value="title" @if($type == 'title') selected="" @endif>{{ __('Schedule Name') }}
                                </option>
                            ...
                            <tbody class="list">
                                @foreach($schedulemessages ?? [] as $schedulemessage)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-dark"
                                                href="{{ route('admin.customer.show', $schedulemessage->user_id) }}">
                                                {{ Str::limit($schedulemessage->user->name ?? '', 15) }}
                                            </a>
                                        </td>
                                        <td>
                                            {{ $schedulemessage->cloudapi->phone ?? '' }}
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="badge {{ badge($schedulemessage->status)['class'] }}">{{ $schedulemessage->status }}</span>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item delete-confirm" href="#"
                                                        data-action="{{ route('admin.schedules.destroy', $schedulemessage->id) }}">{{ __('Remove') }}</a>
