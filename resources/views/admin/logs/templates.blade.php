                ...
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Active Templates') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <h5 class="card-title  text-muted mb-0">{{ __('Inactive Templates') }}</h5>
                            <p></p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="" class="card-header-form">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="type">
                                ...
                                <option value="title" @if($type == 'title') selected="" @endif>{{ __('Template Name') }}
                                </option>
                                <option value="uuid" @if($type == 'uuid') selected="" @endif>{{ __('Template Id') }}</option>
                                <option value="type" @if($type == 'type') selected="" @endif>{{ __('Template Type') }}
                                </option>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item delete-confirm" href="#"
                                                        data-action="{{ route('admin.template.destroy', $template->id) }}">{{ __('Remove') }}</a>
