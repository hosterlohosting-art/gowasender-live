...
<div class="col-sm-12">
   ...
   <form class="installer_form_instant_reload" method="post" action="{{ route('install.store') }}">
      ...
      <div class="form-group mt-5">
         ...
         <input type="text" name="site_name" class="form-control" required="" placeholder="Your App Name" maxlength="20">
      </div>
      ...
      <div class="form-row">
         <div class="col-sm-6">
            <div class="form-group">
               ...
               <input type="text" name="db_host" class="form-control" required="" placeholder="localhost" value="localhost">
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group">
      ...
      <i class="fi  fi-rs-angle-right text-right"></i>
      </button>
