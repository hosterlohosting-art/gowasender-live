...
<ul class="navbar-nav">
  <li class="nav-item">
    <a class="nav-link {{ Request::is('admin/cloudapis*') ? 'active' : '' }}" href="{{ route('admin.cloudapis.index') }}">
      <i class="fi fi-rs-devices"></i>
      <span class="nav-link-text">{{ __('CloudApis') }}</span>
    </a>
  </li>
  <li class="nav-item">
...
<ul class="navbar-nav">
<li class="nav-item">
    <a class="nav-link {{ Request::is('admin/section*') ? 'active' : '' }}" href="{{ route('admin.section.index') }}">
...
<ul class="navbar-nav mb-md-3">
  ...
  <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.addons.index') }}">
      ...
      <span class="nav-link-text">{{ __('Addons') }}</span>
    </a>
  </li>
