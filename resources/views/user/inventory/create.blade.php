...
@section('content')
<div class="hello">
  <h3>Hello, <span class="blue">{{Auth::user()->name;}}</span></h3>
  <h6>Have a nice day!</h6>
</div>
<div class="armi">
  <div class="col-xl-3 col-md-6">
    <div class="card card-stats yl">
      <!-- Card body -->
      <div class="card-body">
        <div class="armi">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Connected APIs') }}</h5>
            <span class="h2 font-weight-bold mb-0" id="total-device"><img src="{{ asset('uploads/loader.gif') }}"></span>
          </div>
          <div class="col-auto">
            <div class="icon icon-shape bg-gradient-primary text-white rounded-circle black shadow ">
    ...
    <div class="card card-stats yl">
      ...
      <div class="card-body">
        <div class="armi">
          ...
          <div class="col-auto">
            <div class="icon icon-shape bg-gradient-primary text-white rounded-circle chartreuse shadow">
    ...
    <div class="card card-stats yl">
      ...
      <div class="card-body">
        <div class="armi">
          ...
          <div class="col-auto">
            <div class="icon icon-shape bg-gradient-primary text-white rounded-circle indianred shadow">
    ...
    <div class="card card-stats yl">
      ...
      <div class="card-body">
        <div class="armi">
          ...
          <div class="col-auto">
            <div class="icon icon-shape bg-gradient-primary text-white rounded-circle thistle shadow">
