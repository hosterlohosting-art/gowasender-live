...
<div class="row justify-content-center">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-12 scrollbar-inner scroll-content scroll-scrolly_visible"
                        style="overflow-x:auto;">
                        <ul class="nav nav-pills" style="flex-wrap: nowrap;" id="myTab4" role="tablist">
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link active" style="width: max-content;" id="home-tab4" data-toggle="tab"
                                    href="#mode_1" role="tab" aria-controls="home"
                                    aria-selected="true">{{ __('Plain Text') }}</a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_2" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('Text With Documents') }}</a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_3" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('Text With Image') }}</a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_4" role="tab" aria-controls="profile" aria-selected="false">
                                    {{ __('Template Message ') }} <small
                                        class="text-danger">{{ __('(Meta Approved)') }}</small>
                                </a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_10" role="tab" aria-controls="profile" aria-selected="false">
                                    {{ __('Button Message ') }}
                                </a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_5" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('List Message') }}</a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_6" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('Audio Message') }}
                                </a>
                            </li>
                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_7" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('Send Location') }}</a>
                            </li>


                            <li class="nav-ar nav-item mt-2">
                                <a class="nav-link" style="width: max-content;" id="profile-tab4" data-toggle="tab"
                                    href="#mode_9" role="tab" aria-controls="profile"
                                    aria-selected="false">{{ __('Send Video') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="myTextarea1" class="form-control one mt-1" name="message" required=""
                                        maxlength="1000"
                            ...
                            <div class="card-body"
                                ...
                                <div class="card"
                                    ...
                                    <div class="card-body" style="">
                                        <p class="card-text" id="previewText1">This is the example text messages to
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small>{{__(' Supported image type:')}}</small> <small
                                        class="text-danger">{{ __('jpg,jpeg,png') }}</small>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea3', '*', '*')">Bold</button>
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea3', '_', '_')">Italic</button>
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea3', '~', '~')">Strike</button>
                                    <button type="button" class="emojipick btn btn-outline-primary btn-sm"
                                        style="padding:8px;">Emoji</button>
                                    <textarea id="myTextarea3" class="form-control one mt-1" name="message" required=""
                                        maxlength="1000"
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="card-body"
                                ...
                                <div class="card"
                                    style="text-align: left; border-top-left-radius: 0; margin-bottom: 5px;">
                                    <img id="filePreviewImage" class="card-img-top" style=""
                                        src="{{ asset('assets/img/img.jpg') }}" alt="Card image cap">
                                    <div class="card-body" style="">
                                        <p class="card-text" id="previewText3">This is the example of Image messages to
                                            demonstrate the Preview panel of whatsApp Api</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea4', '*', '*')">Bold</button>
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea4', '_', '_')">Italic</button>
                                    <button type="button" class="btn btn-outline-primary btn-sm" style="padding:8px;"
                                        onclick="insertTag('myTextarea4', '~', '~')">Strike</button>
                                    <button type="button" class="emojipick btn btn-outline-primary btn-sm"
                                        style="padding:8px;">Emoji</button>
                                    <textarea id="myTextarea4" class="form-control" required="" name="message"
                                        placeholder="{{ __('Example: This is a list') }}"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="heading4" type="text" class="form-control" name="header_title"
                                        placeholder="{{ __('Example: Amazing boldfaced list title') }}" value=""
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="footerText4" type="text" class="form-control" name="footer_text"
                                        placeholder="{{ __('Example: Thank you') }}" value="" required="" maxlength="50"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="buttonText4" type="text" class="form-control" name="button_text"
                                        placeholder="{{ __('Example: Required, text on the button to view the list') }}"
                                ...
                                <div class="col-6">
                                    <a href="javascript:void(0)" id="add-more-option"
                                        class="btn btn-sm btn-primary btn-neutral float-right mb-1"><i
                                            class="fa fa-plus"></i>&nbsp; {{ __('Add More Card') }}</a>
                                </div>
                            </div>
                            <div class="list-area">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="section[1][title]"
                                                        placeholder="{{ __('Example: Select a fruit') }}" value=""
                                                        required="" maxlength="50" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row list-item-area1">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control itemval-1"
                                                        name="section[1][value][1][title]"
                                                        placeholder="{{ __('Example: Banana') }}" value="" required=""
                                                        maxlength="50" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        placeholder="{{ __('Example: Banana is a healthly food') }}"
                                                        value="" maxlength="50" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-right">
                                                <a href="javascript:void(0)"
                                                    class="text-right btn btn-sm btn-neutral add-more-option-item option-item-btn1"
                                                    data-target=".list-item-area1" data-key="1"><i
                                                        class="fas fa-plus"></i>&nbsp{{ __('Add More Item') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body"
                                ...
                                <div class="card"
                                    ...
                                    <div class="card-body" style="">
                                        ...
                                        <p class="card-text" id="previewText4">This is the example of List messages to
                                            demonstrate the Preview panel of whatsApp Api</p>
                                        <span id="previewFooter4" class="text-muted text-xs">This is footer
                                            example</span>
                                    </div>
                                </div>
